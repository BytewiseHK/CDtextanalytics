...
def extract_main_article(soup):
    try:
        ...
        print(f"Error extracting main article: {e}")
        return None
...
def extract_recommended_articles(soup):
    ...
    for item in soup.find_all("div", class_="news-item"):
        try:
            ...
            print(f"Error extracting recommended article: {e}")
    return articles
...
def main():
    # Target URL
    url = "https://news.dayoo.com/china/202501/18/139997_54777019.htm"
    ...
    # Save to JSON
    save_to_json(data, "articles03.json")

    # Save recommended articles to Excel
    if recommended_articles:
        save_to_excel(recommended_articles, "recommended_articles03.xlsx")
