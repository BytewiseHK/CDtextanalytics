...
def save_content_to_file(content, output_folder):
    ...
    """
    filename = f"article_{random.randint(1000, 9999)}.txt"
...
def main():
    ...
    while to_visit_urls:
        ...
        # Check if we should pause after processing 50 URLs
        urls_processed = len(visited_urls)
        if urls_processed % 50 == 0:  # Prompt after every 50 URLs
